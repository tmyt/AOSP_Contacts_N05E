...
import com.android.contacts2.ContactLoader;
import com.android.contacts2.ContactSaveService;
import com.android.contacts2.ContactsActivity;
import com.android.contacts2.ContactsUtils;
import com.android.contacts2.R;
import com.android.contacts2.activities.ActionBarAdapter.TabState;
import com.android.contacts2.detail.ContactDetailFragment;
import com.android.contacts2.detail.ContactDetailLayoutController;
import com.android.contacts2.detail.ContactDetailUpdatesFragment;
import com.android.contacts2.detail.ContactLoaderFragment;
import com.android.contacts2.detail.ContactLoaderFragment.ContactLoaderFragmentListener;
import com.android.contacts2.dialog.ClearFrequentsDialog;
import com.android.contacts2.group.GroupBrowseListFragment;
import com.android.contacts2.group.GroupBrowseListFragment.OnGroupBrowserActionListener;
import com.android.contacts2.group.GroupDetailFragment;
import com.android.contacts2.interactions.ContactDeletionInteraction;
import com.android.contacts2.interactions.ImportExportDialogFragment;
import com.android.contacts2.interactions.PhoneNumberInteraction;
import com.android.contacts2.list.ContactBrowseListFragment;
import com.android.contacts2.list.ContactEntryListFragment;
import com.android.contacts2.list.ContactListFilter;
import com.android.contacts2.list.ContactListFilterController;
import com.android.contacts2.list.ContactTileAdapter.DisplayType;
import com.android.contacts2.list.ContactTileFrequentFragment;
import com.android.contacts2.list.ContactTileListFragment;
import com.android.contacts2.list.ContactsIntentResolver;
import com.android.contacts2.list.ContactsRequest;
import com.android.contacts2.list.ContactsUnavailableFragment;
import com.android.contacts2.list.DefaultContactBrowseListFragment;
import com.android.contacts2.list.DirectoryListLoader;
import com.android.contacts2.list.OnContactBrowserActionListener;
import com.android.contacts2.list.OnContactsUnavailableActionListener;
import com.android.contacts2.list.ProviderStatusWatcher;
import com.android.contacts2.list.ProviderStatusWatcher.ProviderStatusListener;
import com.android.contacts2.model.AccountWithDataSet;
import com.android.contacts2.preference.ContactsPreferenceActivity;
import com.android.contacts2.preference.DisplayOptionsPreferenceFragment;
import com.android.contacts2.util.AccountFilterUtil;
import com.android.contacts2.util.AccountPromptUtils;
import com.android.contacts2.util.Constants;
import com.android.contacts2.util.DialogManager;
import com.android.contacts2.util.HelpUtils;
import com.android.contacts2.util.PhoneCapabilityTester;
import com.android.contacts2.util.UriUtils;
import com.android.contacts2.widget.TransitionAnimationView;
